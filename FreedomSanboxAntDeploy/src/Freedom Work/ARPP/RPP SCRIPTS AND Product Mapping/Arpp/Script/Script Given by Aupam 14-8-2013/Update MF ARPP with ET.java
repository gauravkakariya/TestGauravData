...
for(Action_Plan_Product__c objActionPlanProduct : [select Action_Plan_Product_Name__c, Product_Name__c from Action_Plan_Product__c where Action_Plan_Product_Name__c IN: mapLIExecutedProductNameTolstET.keySet() and CreatedDate = TODAY])
