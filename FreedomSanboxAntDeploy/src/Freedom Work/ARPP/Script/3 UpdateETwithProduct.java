...
Map<Id, Execution_Tracker__c> mapNewIdToET = new Map<Id, Execution_Tracker__c>([Select Type__c, Execution_Tracker_Product__c,  Executed_Product_Name__c From Execution_Tracker__c where Entity_Name__c IN:lstEntity And ParentExecutionTracker__c = NULL and Approve_Action_Plan__r.Investment_Asset__c = null]);
